...
export function QuestionHearButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`flex shrink-0 items-center justify-center rounded-2xl border-4 border-orange-200 bg-orange-400 text-white shadow-lg transition hover:bg-orange-300 ${sizeClasses[size]}`}
    >
